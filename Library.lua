...
local library = {
    ...
    folders = {
        main = "Eternity",
        assets = "Eternity/Images",
        configs = "Eternity/Configs"
    },
    shared = {
        initialized = false,
        fps = 0,
...
do
    ...
    function library:Loader(info)
        ...
        function window:CloseContent()
            if window.currentContent.dropdown and window.currentContent.dropdown.open then
                ...
                utility:LoadImage(dropdown.dropdown_image, "arrow_down", "https://raw.githubusercontent.com/f1nobe7650/other/main/uis/osiris/arrow_down.png")
                --
            ...
            elseif window.currentContent.multibox and window.currentContent.multibox.open then
                ...
                utility:LoadImage(multibox.multibox_image, "arrow_down", "https://raw.githubusercontent.com/f1nobe7650/other/main/uis/osiris/arrow_down.png")
                --
    ...
    function library:New(info)
        ...
        theme.accent = accent
        --
        local window = {pages = {}, loader = style == 2, init = false, pageammount = pageammount, isVisible = false, callback = callback, uibind = Enum.KeyCode.Z, wminfo = "Eternity || UID : %u || Ping : %s || Fps : %u", currentPage = nil, fading = false, dragging = false, drag = Vector2.new(0,0), currentContent = {frame = nil, dropdown = nil, multibox = nil, colorpicker = nil, keybind = nil, textbox = nil}}
        --
        local main_frame = utility:Create("Frame", {Vector2.new(0,0)}, {
            Size = utility:Size(0, size.X, 0, size.Y),
            Position = utility:Position(0.5, -(size.X/2) ,0.5, -(size.Y/2)),
    ...
    function pages:PlayerList(info)
        ...
        for Index = 1, 1 do
            ...
            --
            utility:LoadImage(button_image, "arrow_down", "https://raw.githubusercontent.com/f1nobe7650/other/main/uis/osiris/arrow_down.png")
            --
            ...
            function button:Open()
                window:CloseContent()
                button.open = not button.open
                utility:LoadImage(button_image, "arrow_up", "https://raw.githubusercontent.com/f1nobe7650/other/main/uis/osiris/arrow_up.png")
                --
            ...
            --
            utility:LoadImage(button_gradient, "gradient", "https://raw.githubusercontent.com/f1nobe7650/other/main/uis/osiris/gradient.png")
            --
            library.began[#library.began + 1] = function(Input)
                if Input.UserInputType == Enum.UserInputType.MouseButton1 and (button_outline.Visible or button.open) and window.isVisible then
                    if Input.UserInputType == Enum.UserInputType.MouseButton1 and window.isVisible and button_outline.Visible then
                        ...
                        elseif utility:MouseOverDrawing({button_outline.Position.X, button_outline.Position.Y, button_outline.Position.X + button_outline.Size.X, button_outline.Position.Y + button_outline.Size.Y}) and not window:IsOverContent() then
                            task.spawn(function()
                                utility:LoadImage(button_gradient, "gradientdown", "https://raw.githubusercontent.com/f1nobe7650/other/main/uis/osiris/gradientdown.png") 
                                --
                                task.wait(0.15)
                                --
                                utility:LoadImage(button_gradient, "gradient", "https://raw.githubusercontent.com/f1nobe7650/other/main/uis/osiris/gradient.png") 
        ...
        --
        utility:LoadImage(list_gradient, "gradient", "https://raw.githubusercontent.com/f1nobe7650/other/main/uis/osiris/gradient.png")
        --
    ...
    function sections:Toggle(info)
        ...
        --
        utility:LoadImage(toggle__gradient, "gradient", "https://raw.githubusercontent.com/f1nobe7650/other/main/uis/osiris/gradient.png")
        --
        function toggle:Get()
        ...
        function toggle:Colorpicker(info)
            ...
            --
            if transp then
                utility:LoadImage(colorpicker__transparency, "cptransp", "https://raw.githubusercontent.com/f1nobe7650/other/main/uis/osiris/cptransp.png")
            end
            utility:LoadImage(colorpicker__gradient, "gradient", "https://raw.githubusercontent.com/f1nobe7650/other/main/uis/osiris/gradient.png")
            --
                    ...
                    elseif utility:MouseOverDrawing({section.section_frame.Position.X + (section.section_frame.Size.X - (colorpicker.index == 0 and (30 + 4 + 2) or (64 + 4 + 2))), section.section_frame.Position.Y + colorpicker.axis, section.section_frame.Position.X + section.section_frame.Size.X - (colorpicker.index == 1 and 36 or 0), section.section_frame.Position.Y + colorpicker.axis + 15}) and not window:IsOverContent() then
                        if not colorpicker.open then
                            ...
                            if transp then
                                ...
                                --
                                utility:LoadImage(colorpicker_open_transparency_image, "transp", "https://raw.githubusercontent.com/f1nobe7650/other/main/uis/osiris/transp.png")
                                --utility:LoadImage(colorpicker_open_transparency_image, "transp", "https://i.imgur.com/VcMAYjL.png")
                            end
                            --
                            utility:LoadImage(colorpicker_open_picker_image, "valsat", "https://raw.githubusercontent.com/f1nobe7650/other/main/uis/osiris/valsat.png")
                            utility:LoadImage(colorpicker_open_picker_cursor, "valsat_cursor", "https://raw.githubusercontent.com/f1nobe7650/other/main/uis/osiris/valsat_cursor.png")
                            utility:LoadImage(colorpicker_open_huepicker_image, "hue", "https://raw.githubusercontent.com/f1nobe7650/other/main/uis/osiris/hue.png")
                            --
        ...
        function toggle:Keybind(info)
            ...
            --
            utility:LoadImage(keybind__gradient, "gradient", "https://raw.githubusercontent.com/f1nobe7650/other/main/uis/osiris/gradient.png")
            --
    ...
    function sections:Slider(info)
        ...
        --
        utility:LoadImage(slider__gradient, "gradient", "https://raw.githubusercontent.com/f1nobe7650/other/main/uis/osiris/gradient.png")
        --
    ...
    function sections:TextBox(info)
        ...
        --
        utility:LoadImage(textbox_gradient, "gradient", "https://raw.githubusercontent.com/f1nobe7650/other/main/uis/osiris/gradient.png")
        --
        ...
        library.began[#library.began + 1] = function(Input)
            if Input.UserInputType == Enum.UserInputType.MouseButton1 and textbox_outline.Visible and window.isVisible then
                if reactive and utility:MouseOverDrawing({section.section_frame.Position.X, section.section_frame.Position.Y + textbox.axis, section.section_frame.Position.X + section.section_frame.Size.X, section.section_frame.Position.Y + textbox.axis + 20}) and not window:IsOverContent() then
                    task.spawn(function()
                        utility:LoadImage(textbox_gradient, "gradientdown", "https://raw.githubusercontent.com/f1nobe7650/other/main/uis/osiris/gradientdown.png") 
                        --
                        task.wait(0.15)
                        --
                        utility:LoadImage(textbox_gradient, "gradient", "https://raw.githubusercontent.com/f1nobe7650/other/main/uis/osiris/gradient.png") 
    ...
    function sections:Dropdown(info)
        ...
        --
        utility:LoadImage(dropdown_image, "arrow_down", "https://raw.githubusercontent.com/f1nobe7650/other/main/uis/osiris/arrow_down.png")
        utility:LoadImage(dropdown__gradient, "gradient", "https://raw.githubusercontent.com/f1nobe7650/other/main/uis/osiris/gradient.png")
        --
        if max then
        ...
        library.began[#library.began + 1] = function(Input)
            if Input.UserInputType == Enum.UserInputType.MouseButton1 and window.isVisible and dropdown_outline.Visible then
                ...
                elseif utility:MouseOverDrawing({section.section_frame.Position.X, section.section_frame.Position.Y + dropdown.axis, section.section_frame.Position.X + section.section_frame.Size.X, section.section_frame.Position.Y + dropdown.axis + (name and (15 + 20) or (20))}) and not window:IsOverContent() then
                    task.spawn(function()
                        utility:LoadImage(dropdown__gradient, "gradientdown", "https://raw.githubusercontent.com/f1nobe7650/other/main/uis/osiris/gradientdown.png") 
                        --
                        task.wait(0.15)
                        --
                        utility:LoadImage(dropdown__gradient, "gradient", "https://raw.githubusercontent.com/f1nobe7650/other/main/uis/osiris/gradient.png") 
                    ...
                    if not dropdown.open then
                        window:CloseContent()
                        dropdown.open = not dropdown.open
                        utility:LoadImage(dropdown_image, "arrow_up", "https://raw.githubusercontent.com/f1nobe7650/other/main/uis/osiris/arrow_up.png")
                        --
    ...
    function sections:Multibox(info)
        ...
        --
        utility:LoadImage(multibox_image, "arrow_down", "https://raw.githubusercontent.com/f1nobe7650/other/main/uis/osiris/arrow_down.png")
        utility:LoadImage(multibox__gradient, "gradient", "https://raw.githubusercontent.com/f1nobe7650/other/main/uis/osiris/gradient.png")
        --
        ...
        library.began[#library.began + 1] = function(Input)
            if Input.UserInputType == Enum.UserInputType.MouseButton1 and window.isVisible and multibox_outline.Visible then
                ...
                elseif utility:MouseOverDrawing({section.section_frame.Position.X, section.section_frame.Position.Y + multibox.axis, section.section_frame.Position.X + section.section_frame.Size.X, section.section_frame.Position.Y + multibox.axis + (name and 15 or 0) + 20}) and not window:IsOverContent() then
                    task.spawn(function()
                        utility:LoadImage(multibox__gradient, "gradientdown", "https://raw.githubusercontent.com/f1nobe7650/other/main/uis/osiris/gradientdown.png") 
                        --
                        task.wait(0.15)
                        --
                        utility:LoadImage(multibox__gradient, "gradient", "https://raw.githubusercontent.com/f1nobe7650/other/main/uis/osiris/gradient.png") 
                    ...
                    if not multibox.open then
                        window:CloseContent()
                        multibox.open = not multibox.open
                        utility:LoadImage(multibox_image, "arrow_up", "https://raw.githubusercontent.com/f1nobe7650/other/main/uis/osiris/arrow_up.png")
                        --
        ...
        library.began[#library.began + 1] = function(Input)
            ...
            if Input.UserInputType == Enum.UserInputType.MouseButton2 and window.isVisible and keybind_outline.Visible then
                if utility:MouseOverDrawing({section.section_frame.Position.X, section.section_frame.Position.Y + keybind.axis, section.section_frame.Position.X + section.section_frame.Size.X, section.section_frame.Position.Y + keybind.axis + 17}) and not window:IsOverContent() and not keybind.selecting then
                    ...
                    --
                    utility:LoadImage(keybind__gradient, "gradient", "https://raw.githubusercontent.com/f1nobe7650/other/main/uis/osiris/arrow_down.png")
                    --
                    for i,v in pairs({"Always", "Toggle", "On Hold", "Off Hold"}) do
                        local button_title = utility:Create("TextLabel", {Vector2.new(modemenu_frame.Size.X/2,15 * (i-1)), modemenu_frame}, {
                            Text = v,
